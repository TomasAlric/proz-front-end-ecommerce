...
// Defina os produtos disponíveis aqui
...
document.getElementById("finalizar-pedido").addEventListener("click", () => {
  fetch("https://9sa19b2fve.execute-api.sa-east-1.amazonaws.com/dev/iniciar-pedido", {
    method: "POST",
    ...
    .then((data) => {
      ...
      if (pedidoId) {
        ...
        localStorage.setItem("pedidoId", pedidoId);  // Armazenando o pedidoId no localStorage

        // Passa o pedidoId diretamente pela URL
        window.location.href = `pedido.html?pedidoId=${pedidoId}`;
      } else {
